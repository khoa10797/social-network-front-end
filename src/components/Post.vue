    ...
    <div class="custom-card card">
        ...
        <div class="container-action-post">
            <div class="action-post">
                <div>
                    <button class="button is-white" v-on:click="updateUserStatus">
        ...
        <div v-if="showInputComment" class="container-comment">
            <div class="input-comment is-flex">
                ...
                <div class="container-input-comment">
                    ...
                    <ckeditor v-else :editor="editor" v-model="valueComment" :config="editorConfig"/>
                </div>

                <div v-if="isLockPost === false" class="btn-send-comment is-flex" @click="sendComment">
